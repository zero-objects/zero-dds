//! ShapesDemo-Publisher — sendet periodisch ShapeType-Samples auf
//! einem der Standard-ShapesDemo-Topics (Square/Circle/Triangle).
//!
//! Interop-Ziel: ein Cyclone-, Fast-DDS- oder RTI-ShapesDemo-Client
//! zeichnet die Forme live auf seinem Canvas mit.
//!
//! # Usage
//!
//! ```text
