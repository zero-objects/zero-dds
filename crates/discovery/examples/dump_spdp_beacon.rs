...
fn main() {
    ...
    let data = ParticipantBuiltinTopicData {
        ...
        default_unicast_locators: vec![Locator::udp_v4(ip, u32::from(uc_port))],
        default_multicast_locators: vec![Locator::udp_v4([239, 255, 0, 1], mc_port)],
        metatraffic_unicast_locators: vec![Locator::udp_v4(ip, u32::from(uc_port))],
        metatraffic_multicast_locators: vec![Locator::udp_v4([239, 255, 0, 1], mc_port)],
