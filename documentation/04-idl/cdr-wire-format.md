...
For the compiler that produces these bytes — including IDL syntax and
annotation semantics — see [`idlc-handbook.md`](idlc-handbook.md).
...
* [`idlc-handbook.md`](idlc-handbook.md) — the compiler manual,
  including IDL syntax and the full annotation reference.
