...
Built-in Monitoring-Topics (DataWriter/Reader/Participant/Heartbeat-Stats).
...
Siehe `crates/monitor/README.md` + `CHANGELOG.md` + `src/`.
...
- Kohärenz: (a) Public-API gewired, (b) Konsumenten in DCPS-Public-API/Bridges, (c) 41 cargo-tests grün

## 8 Tests + Lints + Doc-Build

- `cargo test -p zerodds-monitor`: 41 Tests
