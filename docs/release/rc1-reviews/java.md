...
Container-Crate fuer den Java-High-Level-Workspace-Build.
...
Siehe `crates/java/README.md` + `CHANGELOG.md` + `src/`.
...
- Workspace-Sync-Container; eigentliche Java-Sources unter `java-omgdds` und `zerodds-java-omgdds`
...
- `cargo test -p java`: 1 cargo-test
