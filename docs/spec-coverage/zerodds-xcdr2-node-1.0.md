...
**Decision-Record:** @mutable-EMHEADER über alle 17 Backends einheitlich nicht emittiert; @final+@appendable decken den gängigen Fall. Cross-cutting Follow-up (roadmap), bewusst zurückgestellt. `idl-ts` gibt `Unsupported`.
